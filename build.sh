...
${nuget_cmd} install src/circuitid-csharp/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/circuitid-csharp.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/circuitid-csharp.dll \
-recurse:'src/circuitid-csharp/*.cs' \
-doc:bin/circuitid-csharp.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/circuitid-csharp.dll was created successfully"
fi
