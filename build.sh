...
${nuget_cmd} install src/Com.CircuitID/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.CircuitID.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.CircuitID.dll \
-recurse:'src/Com.CircuitID/*.cs' \
-doc:bin/Com.CircuitID.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.CircuitID.dll was created successfully"
fi
