# circuitid-csharp.CircuitID.MessageCampaignsApi
...
> Object CreateMessageCampaign (Messagecampaigns messagecampaigns)
...
namespace Example
{
    public class CreateMessageCampaignExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MessageCampaignsApi.CreateMessageCampaign: " + e.Message );
...
> FindMessageCampaigns200Response FindMessageCampaigns (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class FindMessageCampaignsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling MessageCampaignsApi.FindMessageCampaigns: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object GetMessageCampaign (Object id)
...
namespace Example
{
    public class GetMessageCampaignExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling MessageCampaignsApi.GetMessageCampaign: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object PatchMessageCampaign (Object id, Messagecampaigns messagecampaigns)
...
namespace Example
{
    public class PatchMessageCampaignExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling MessageCampaignsApi.PatchMessageCampaign: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object RemoveMessageCampaign (Object id)
...
namespace Example
{
    public class RemoveMessageCampaignExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling MessageCampaignsApi.RemoveMessageCampaign: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
