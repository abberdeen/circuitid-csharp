# circuitid-csharp.CircuitID.AnnouncementsApi
...
> Object CreateAnnouncement (Announcements announcements)
...
namespace Example
{
    public class CreateAnnouncementExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AnnouncementsApi.CreateAnnouncement: " + e.Message );
...
> FindAnnouncements200Response FindAnnouncements (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class FindAnnouncementsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling AnnouncementsApi.FindAnnouncements: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object GetAnnouncement (Object id)
...
namespace Example
{
    public class GetAnnouncementExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling AnnouncementsApi.GetAnnouncement: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object PatchAnnouncement (Object id, Announcements announcements)
...
namespace Example
{
    public class PatchAnnouncementExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling AnnouncementsApi.PatchAnnouncement: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object RemoveAnnouncement (Object id)
...
namespace Example
{
    public class RemoveAnnouncementExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling AnnouncementsApi.RemoveAnnouncement: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
