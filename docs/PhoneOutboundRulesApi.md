# circuitid-csharp.CircuitID.PhoneOutboundRulesApi
...
namespace Example
{
    public class CreatePhoneOutboundRuleExample
    {
        public static void Main()
        {
            ...
            var phoneoutboundrules = new Phoneoutboundrules(); // Phoneoutboundrules | The JSON object that will be posted to the REST API endpoint.
...
> FindPhoneOutboundRules200Response FindPhoneOutboundRules (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class PatchPhoneOutboundRuleExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PhoneOutboundRulesApi(Configuration.Default);
            var id = new Object(); // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
            var phoneoutboundrules = new Phoneoutboundrules(); // Phoneoutboundrules | The request data.
