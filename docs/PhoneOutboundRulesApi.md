# Com.CircuitID.Api.PhoneOutboundRulesApi
...
> GetPhoneOutboundRule200Response CreatePhoneOutboundRule (PhoneoutboundrulesCreateOrPatch phoneoutboundrulesCreateOrPatch)
...
namespace Example
{
    public class CreatePhoneOutboundRuleExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PhoneOutboundRulesApi(Configuration.Default);
            var phoneoutboundrulesCreateOrPatch = new PhoneoutboundrulesCreateOrPatch(); // PhoneoutboundrulesCreateOrPatch | The JSON object that will be posted to the REST API endpoint.
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRulesApi.CreatePhoneOutboundRule: " + e.Message );
...
> FindPhoneOutboundRules200Response FindPhoneOutboundRules (string search = null, int? limit = null, int? skip = null, Object sort = null, List<string> select = null, List<Object> or = null, List<Object> and = null)
...
namespace Example
{
    public class FindPhoneOutboundRulesExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRulesApi.FindPhoneOutboundRules: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRule200Response GetPhoneOutboundRule (string id)
...
namespace Example
{
    public class GetPhoneOutboundRuleExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRulesApi.GetPhoneOutboundRule: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRule200Response PatchPhoneOutboundRule (string id, PhoneoutboundrulesCreateOrPatch phoneoutboundrulesCreateOrPatch)
...
namespace Example
{
    public class PatchPhoneOutboundRuleExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            var apiInstance = new PhoneOutboundRulesApi(Configuration.Default);
            var id = "id_example";  // string | The ObjectId (unique 12 bytes ID) of record you would like to GET.
            var phoneoutboundrulesCreateOrPatch = new PhoneoutboundrulesCreateOrPatch(); // PhoneoutboundrulesCreateOrPatch | The request data.
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRulesApi.PatchPhoneOutboundRule: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRule200Response RemovePhoneOutboundRule (string id)
...
namespace Example
{
    public class RemovePhoneOutboundRuleExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRulesApi.RemovePhoneOutboundRule: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
