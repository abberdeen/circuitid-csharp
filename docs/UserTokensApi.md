# circuitid-csharp.CircuitID.UserTokensApi
...
> Object CreateUserToken (Usertokens usertokens)
...
namespace Example
{
    public class CreateUserTokenExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UserTokensApi.CreateUserToken: " + e.Message );
...
> FindUserTokens200Response FindUserTokens (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class FindUserTokensExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling UserTokensApi.FindUserTokens: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetUserTokenExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UserTokensApi.GetUserToken: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object PatchUserToken (Object id, Usertokens usertokens)
...
namespace Example
{
    public class PatchUserTokenExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling UserTokensApi.PatchUserToken: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object RemoveUserToken (Object id)
...
namespace Example
{
    public class RemoveUserTokenExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling UserTokensApi.RemoveUserToken: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
