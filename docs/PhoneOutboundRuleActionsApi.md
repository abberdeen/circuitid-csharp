# Com.CircuitID.Api.PhoneOutboundRuleActionsApi
...
> GetPhoneOutboundRuleAction200Response CreatePhoneOutboundRuleAction (PhoneoutboundruleactionsCreateOrPatch phoneoutboundruleactionsCreateOrPatch)
...
namespace Example
{
    public class CreatePhoneOutboundRuleActionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PhoneOutboundRuleActionsApi(Configuration.Default);
            var phoneoutboundruleactionsCreateOrPatch = new PhoneoutboundruleactionsCreateOrPatch(); // PhoneoutboundruleactionsCreateOrPatch | The JSON object that will be posted to the REST API endpoint.
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRuleActionsApi.CreatePhoneOutboundRuleAction: " + e.Message );
...
> FindPhoneOutboundRuleActions200Response FindPhoneOutboundRuleActions (string search = null, int? limit = null, int? skip = null, Object sort = null, List<string> select = null, List<Object> or = null, List<Object> and = null)
...
namespace Example
{
    public class FindPhoneOutboundRuleActionsExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRuleActionsApi.FindPhoneOutboundRuleActions: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRuleAction200Response GetPhoneOutboundRuleAction (string id)
...
namespace Example
{
    public class GetPhoneOutboundRuleActionExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRuleActionsApi.GetPhoneOutboundRuleAction: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRuleAction200Response PatchPhoneOutboundRuleAction (string id, PhoneoutboundruleactionsCreateOrPatch phoneoutboundruleactionsCreateOrPatch)
...
namespace Example
{
    public class PatchPhoneOutboundRuleActionExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            var apiInstance = new PhoneOutboundRuleActionsApi(Configuration.Default);
            var id = "id_example";  // string | The ObjectId (unique 12 bytes ID) of record you would like to GET.
            var phoneoutboundruleactionsCreateOrPatch = new PhoneoutboundruleactionsCreateOrPatch(); // PhoneoutboundruleactionsCreateOrPatch | The request data.
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRuleActionsApi.PatchPhoneOutboundRuleAction: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> GetPhoneOutboundRuleAction200Response RemovePhoneOutboundRuleAction (string id)
...
namespace Example
{
    public class RemovePhoneOutboundRuleActionExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling PhoneOutboundRuleActionsApi.RemovePhoneOutboundRuleAction: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
