...
> FindInvoices200Response FindInvoices (string search = null, int? limit = null, int? skip = null, Object sort = null, List<string> select = null, List<Object> or = null, List<Object> and = null)
...
namespace Example
{
    public class FindInvoicesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling InvoicesApi.FindInvoices: " + e.Message );
...
> GetInvoice200Response GetInvoice (string id)
