# Com.CircuitID.Api.DirectoriesApi
...
> FindDirectories200Response FindDirectories (string search = null, int? limit = null, int? skip = null, Object sort = null, List<string> select = null, List<Object> or = null, List<Object> and = null)
...
namespace Example
{
    public class FindDirectoriesExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://rest.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling DirectoriesApi.FindDirectories: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Getdirectory200Response Getdirectory (string id)
...
> Getdirectory200Response Removedirectory (string id)
