# circuitid-csharp.CircuitID.FaxAccountApi
...
> Object CreateFaxAccount (Faxaccounts faxaccounts)
...
> Object GetFaxAccount (Object id)
...
> Object PatchFaxAccount (Object id, Faxaccounts faxaccounts)
...
> Object RemoveFaxAccount (Object id)
