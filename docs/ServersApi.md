# circuitid-csharp.CircuitID.ServersApi
...
> Object CreateServer (Servers servers)
...
namespace Example
{
    public class CreateServerExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ServersApi.CreateServer: " + e.Message );
...
> FindServers200Response FindServers (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class FindServersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ServersApi.FindServers: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetServerExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ServersApi.GetServer: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> Object PatchServer (Object id, Servers servers)
...
namespace Example
{
    public class PatchServerExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling ServersApi.PatchServer: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RemoveServerExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling ServersApi.RemoveServer: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
