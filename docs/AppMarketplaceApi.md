# Com.CircuitID.Api.AppMarketplaceApi
...
> FindAppMarketplace200Response FindAppMarketplace (string search = null, int? limit = null, int? skip = null, Object sort = null, List<string> select = null, List<Object> or = null, List<Object> and = null)
...
namespace Example
{
    public class FindAppMarketplaceExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AppMarketplaceApi(Configuration.Default);
            ...
            {
                Debug.Print("Exception when calling AppMarketplaceApi.FindAppMarketplace: " + e.Message );
