# circuitid-csharp.CircuitID.LicensesApi
...
namespace Example
{
    public class CreateLicenseExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling LicensesApi.CreateLicense: " + e.Message );
...
> FindLicenses200Response FindLicenses (Object search = null, Object limit = null, Object skip = null, Object sort = null, Object select = null, Object or = null, Object and = null)
...
namespace Example
{
    public class FindLicensesExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling LicensesApi.FindLicenses: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class GetLicenseExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling LicensesApi.GetLicense: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class PatchLicenseExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "https://cloud9.circuitid.com";
            ...
            {
                Debug.Print("Exception when calling LicensesApi.PatchLicense: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class RemoveLicenseExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling LicensesApi.RemoveLicense: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
