...
namespace Com.CircuitID.Api
{
    ...
    public interface IVoicemailApi : IApiAccessor
    {
        ...
        FindAppMarketplace200Response FindVoicemail (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>));
        ...
        ApiResponse<FindAppMarketplace200Response> FindVoicemailWithHttpInfo (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>));
        /// <summary>
        /// Get object by id
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<Object> GetVoicemailWithHttpInfo (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<FindAppMarketplace200Response>> FindVoicemailWithHttpInfoAsync (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get object by id
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task GetVoicemailAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetVoicemailWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class VoicemailApi : IVoicemailApi
    {
        ...
        /// <param name="and">Find all records that match all of the given criteria. (optional)</param>
        /// <returns>FindAppMarketplace200Response</returns>
        public FindAppMarketplace200Response FindVoicemail (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>))
        {
             ApiResponse<FindAppMarketplace200Response> localVarResponse = FindVoicemailWithHttpInfo(search, limit, skip, sort, select, or, and);
        ...
        /// <param name="and">Find all records that match all of the given criteria. (optional)</param>
        /// <returns>ApiResponse of FindAppMarketplace200Response</returns>
        public ApiResponse<FindAppMarketplace200Response> FindVoicemailWithHttpInfo (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>))
        {
        ...
        {
             ApiResponse<FindAppMarketplace200Response> localVarResponse = await FindVoicemailWithHttpInfoAsync(search, limit, skip, sort, select, or, and, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (FindAppMarketplace200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FindAppMarketplace200Response>> FindVoicemailWithHttpInfoAsync (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="id">The ObjectId (unique 12 bytes ID) of record you would like to GET.</param>
        /// <returns></returns>
        public void GetVoicemail (string id)
        {
        ...
        /// <param name="id">The ObjectId (unique 12 bytes ID) of record you would like to GET.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetVoicemailWithHttpInfo (string id)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetVoicemailAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetVoicemailWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling VoicemailApi->GetVoicemail");
