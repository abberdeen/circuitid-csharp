...
namespace Com.CircuitID.Api
{
    ...
    public interface IFaxesApi : IApiAccessor
    {
        ...
        ApiResponse<GetFax200Response> CreateFaxWithHttpInfo (Faxes faxes);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetFax200Response> CreateFaxAsync (Faxes faxes, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetFax200Response>> CreateFaxWithHttpInfoAsync (Faxes faxes, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Find multiple objects
        /// </summary>
        /// <remarks>
    ...
    public partial class FaxesApi : IFaxesApi
    {
        ...
        /// <param name="faxes">The JSON object that will be posted to the REST API endpoint.</param>
        /// <returns>GetFax200Response</returns>
        public GetFax200Response CreateFax (Faxes faxes)
        {
             ApiResponse<GetFax200Response> localVarResponse = CreateFaxWithHttpInfo(faxes);
        ...
        /// <param name="faxes">The JSON object that will be posted to the REST API endpoint.</param>
        /// <returns>ApiResponse of GetFax200Response</returns>
        public ApiResponse<GetFax200Response> CreateFaxWithHttpInfo (Faxes faxes)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of GetFax200Response</returns>
        public async System.Threading.Tasks.Task<GetFax200Response> CreateFaxAsync (Faxes faxes, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<GetFax200Response> localVarResponse = await CreateFaxWithHttpInfoAsync(faxes, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (GetFax200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetFax200Response>> CreateFaxWithHttpInfoAsync (Faxes faxes, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'faxes' is set
            if (faxes == null)
                throw new ApiException(400, "Missing required parameter 'faxes' when calling FaxesApi->CreateFax");
