...
namespace Com.CircuitID.Api
{
    ...
    public interface IDNSRecordsApi : IApiAccessor
    {
        ...
        FindAppMarketplace200Response FindDNSRecords (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>));
        ...
        ApiResponse<FindAppMarketplace200Response> FindDNSRecordsWithHttpInfo (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>));
        ...
        System.Threading.Tasks.Task<ApiResponse<FindAppMarketplace200Response>> FindDNSRecordsWithHttpInfoAsync (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DNSRecordsApi : IDNSRecordsApi
    {
        ...
        /// <returns></returns>
        public DNSRecordsApi(Com.CircuitID.Client.Configuration configuration = null)
        {
        ...
        /// <param name="and">Find all records that match all of the given criteria. (optional)</param>
        /// <returns>FindAppMarketplace200Response</returns>
        public FindAppMarketplace200Response FindDNSRecords (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>))
        {
             ApiResponse<FindAppMarketplace200Response> localVarResponse = FindDNSRecordsWithHttpInfo(search, limit, skip, sort, select, or, and);
        ...
        /// <param name="and">Find all records that match all of the given criteria. (optional)</param>
        /// <returns>ApiResponse of FindAppMarketplace200Response</returns>
        public ApiResponse<FindAppMarketplace200Response> FindDNSRecordsWithHttpInfo (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>))
        {
        ...
        {
             ApiResponse<FindAppMarketplace200Response> localVarResponse = await FindDNSRecordsWithHttpInfoAsync(search, limit, skip, sort, select, or, and, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (FindAppMarketplace200Response)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FindAppMarketplace200Response>> FindDNSRecordsWithHttpInfoAsync (string search = default(string), int? limit = default(int?), int? skip = default(int?), Object sort = default(Object), List<string> select = default(List<string>), List<Object> or = default(List<Object>), List<Object> and = default(List<Object>), CancellationToken cancellationToken = default(CancellationToken))
        {
