...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetTimeSchedule200Response :  IEquatable<GetTimeSchedule200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Timezone
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTimeSchedule200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTimeSchedule200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTimeSchedule200Response" /> class.
        /// </summary>
        ...
        public GetTimeSchedule200Response(string name = default(string), TimezoneEnum timezone = TimezoneEnum.AmericaNewYork, TimeschedulesSunday sunday = default(TimeschedulesSunday), TimeschedulesSunday monday = default(TimeschedulesSunday), TimeschedulesSunday tuesday = default(TimeschedulesSunday), TimeschedulesSunday wednesday = default(TimeschedulesSunday), TimeschedulesSunday thursday = default(TimeschedulesSunday), TimeschedulesSunday friday = default(TimeschedulesSunday), TimeschedulesSunday saturday = default(TimeschedulesSunday), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (timezone == null)
            {
                throw new InvalidDataException("timezone is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
            ...
            if (sunday == null)
            {
                throw new InvalidDataException("sunday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
                this.Sunday = sunday;
            ...
            if (monday == null)
            {
                throw new InvalidDataException("monday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
                this.Monday = monday;
            ...
            if (tuesday == null)
            {
                throw new InvalidDataException("tuesday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
            ...
            if (wednesday == null)
            {
                throw new InvalidDataException("wednesday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
            ...
            if (thursday == null)
            {
                throw new InvalidDataException("thursday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
            ...
            if (friday == null)
            {
                throw new InvalidDataException("friday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
                this.Friday = friday;
            ...
            if (saturday == null)
            {
                throw new InvalidDataException("saturday is a required property for GetTimeSchedule200Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetTimeSchedule200Response);
        }

        /// <summary>
        /// Returns true if GetTimeSchedule200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTimeSchedule200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTimeSchedule200Response input)
        {
            if (input == null)
                return false;
