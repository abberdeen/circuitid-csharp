...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPhoneOutboundRuleAction200Response :  IEquatable<GetPhoneOutboundRuleAction200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneOutboundRuleAction200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPhoneOutboundRuleAction200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneOutboundRuleAction200Response" /> class.
        /// </summary>
        ...
        public GetPhoneOutboundRuleAction200Response(string name = default(string), string group = default(string), string phoneoutboundrule = default(string), StatusEnum? status = StatusEnum.NUMBER_1, int priority = 1, string startingChars = default(string), string contains = default(string), LengthTypeEnum? lengthType = default(LengthTypeEnum?), int length = default(int), string appendChars = default(string), string prependChars = default(string), int rangeStart = default(int), int rangeEnd = default(int), int removeStartingChars = default(int), int removeEndingChars = default(int), RouteEnum route = RouteEnum.Default, RoutingTypeEnum? routingType = default(RoutingTypeEnum?), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetPhoneOutboundRuleAction200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("phoneoutboundrule is a required property for GetPhoneOutboundRuleAction200Response and cannot be null");
            }
            else
            {
            ...
            if (priority == null)
            {
                throw new InvalidDataException("priority is a required property for GetPhoneOutboundRuleAction200Response and cannot be null");
            }
            else
            {
            ...
            if (route == null)
            {
                throw new InvalidDataException("route is a required property for GetPhoneOutboundRuleAction200Response and cannot be null");
            }
            else
            {
                this.Route = route;
        ...
        {
            return this.Equals(input as GetPhoneOutboundRuleAction200Response);
        }

        /// <summary>
        /// Returns true if GetPhoneOutboundRuleAction200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPhoneOutboundRuleAction200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPhoneOutboundRuleAction200Response input)
        {
            if (input == null)
                return false;
