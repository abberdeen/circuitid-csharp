...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FaxaccountsCreateOrPatch :  IEquatable<FaxaccountsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FaxaccountsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FaxaccountsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FaxaccountsCreateOrPatch" /> class.
        /// </summary>
        ...
        public FaxaccountsCreateOrPatch(string name = default(string), string order = default(string), string inboundNotification = default(string), string outboundNotification = default(string), string number = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FaxaccountsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as FaxaccountsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if FaxaccountsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of FaxaccountsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxaccountsCreateOrPatch input)
        {
            if (input == null)
                return false;
