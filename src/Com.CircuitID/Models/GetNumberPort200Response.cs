...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetNumberPort200Response :  IEquatable<GetNumberPort200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNumberPort200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetNumberPort200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNumberPort200Response" /> class.
        /// </summary>
        ...
        public GetNumberPort200Response(List<string> numbers = default(List<string>), string name = default(string), TypeEnum type = TypeEnum.In, TypeOfServiceEnum typeOfService = default(TypeOfServiceEnum), string authorizedPerson = default(string), DateTime desiredDueDate = default(DateTime), string accountNumber = default(string), string accountPhoneNumber = default(string), string office = default(string), E911Enum? e911 = E911Enum.NUMBER_0, string invoice = default(string), StatusEnum status = StatusEnum.Processing, DestinationTypeEnum destinationType = default(DestinationTypeEnum), string destination = default(string), string _ref = default(string), string callForwardingDestination = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("typeOfService is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("authorizedPerson is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("desiredDueDate is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountNumber is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountPhoneNumber is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            if (office == null)
            {
                throw new InvalidDataException("office is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
                this.Office = office;
            ...
            if (invoice == null)
            {
                throw new InvalidDataException("invoice is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("destinationType is a required property for GetNumberPort200Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetNumberPort200Response);
        }

        /// <summary>
        /// Returns true if GetNumberPort200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetNumberPort200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetNumberPort200Response input)
        {
            if (input == null)
                return false;
