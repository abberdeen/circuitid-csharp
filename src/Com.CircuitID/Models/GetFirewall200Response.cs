...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetFirewall200Response :  IEquatable<GetFirewall200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFirewall200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetFirewall200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFirewall200Response" /> class.
        /// </summary>
        ...
        /// <param name="ai">ai (default to AiEnum.NUMBER_0).</param>
        /// <param name="status">status (default to StatusEnum.NUMBER_1).</param>
        /// <param name="notificationHits">notificationHits (default to 1).</param>
        ...
        public GetFirewall200Response(string name = default(string), string description = default(string), int priority = default(int), TypeEnum type = default(TypeEnum), TargetEnum target = default(TargetEnum), DirectionEnum? direction = default(DirectionEnum?), string param = default(string), int hits = default(int), AiEnum? ai = AiEnum.NUMBER_0, StatusEnum? status = StatusEnum.NUMBER_1, int notificationHits = 1, string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetFirewall200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (priority == null)
            {
                throw new InvalidDataException("priority is a required property for GetFirewall200Response and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GetFirewall200Response and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (target == null)
            {
                throw new InvalidDataException("target is a required property for GetFirewall200Response and cannot be null");
            }
            else
            {
                this.Target = target;
            ...
            if (param == null)
            {
                throw new InvalidDataException("param is a required property for GetFirewall200Response and cannot be null");
            }
            else
            {
                this.Param = param;
            ...
            this.Hits = hits;
            // use default value if no "ai" provided
            if (ai == null)
            {
                this.Ai = AiEnum.NUMBER_0;
            }
            else
            {
                this.Ai = ai;
            ...
            // use default value if no "notificationHits" provided
            if (notificationHits == null)
            {
                this.NotificationHits = 1;
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="notificationHits", EmitDefaultValue=false)]
        public int NotificationHits { get; set; }
        ...
        {
            return this.Equals(input as GetFirewall200Response);
        }

        /// <summary>
        /// Returns true if GetFirewall200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFirewall200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFirewall200Response input)
        {
            if (input == null)
                return false;
