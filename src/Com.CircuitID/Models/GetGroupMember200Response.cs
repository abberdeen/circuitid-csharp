...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetGroupMember200Response :  IEquatable<GetGroupMember200Response>, IValidatableObject
    {
        ...
        public GetGroupMember200Response(string group = default(string), string _object = default(string), int priority = default(int), RefEnum _ref = default(RefEnum), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
