...
namespace Com.CircuitID.Models
{
    ...
    public partial class ResponseError :  IEquatable<ResponseError>, IValidatableObject
    {
        ...
        public ResponseError(string name = default(string), string message = default(string), int code = default(int), string className = default(string), List<string> errors = default(List<string>))
        {
            this.Name = name;
