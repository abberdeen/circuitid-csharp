...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetLicense200Response :  IEquatable<GetLicense200Response>, IValidatableObject
    {
        ...
        public GetLicense200Response(string order = default(string), string _object = default(string), string _ref = default(string), string field = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
