...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetMessageCampaign200Response :  IEquatable<GetMessageCampaign200Response>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageCampaign200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMessageCampaign200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMessageCampaign200Response" /> class.
        /// </summary>
        ...
        public GetMessageCampaign200Response(string name = default(string), string campaignId = default(string), string brandId = default(string), string order = default(string), SubscriberOptinEnum? subscriberOptin = default(SubscriberOptinEnum?), SubscriberOptoutEnum? subscriberOptout = default(SubscriberOptoutEnum?), SubscriberHelpEnum? subscriberHelp = default(SubscriberHelpEnum?), NumberPoolEnum? numberPool = default(NumberPoolEnum?), DirectLendingEnum? directLending = default(DirectLendingEnum?), EmbeddedLinkEnum? embeddedLink = default(EmbeddedLinkEnum?), EmbeddedPhoneEnum? embeddedPhone = default(EmbeddedPhoneEnum?), AffiliateMarketingEnum? affiliateMarketing = default(AffiliateMarketingEnum?), AgeGatedEnum? ageGated = default(AgeGatedEnum?), Object mnos = default(Object), string referenceId = default(string), string useCase = default(string), List<Object> subUseCases = default(List<Object>), string sample1 = default(string), string sample2 = default(string), string sample3 = default(string), string sample4 = default(string), string sample5 = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            ...
            if (brandId == null)
            {
                throw new InvalidDataException("brandId is a required property for GetMessageCampaign200Response and cannot be null");
            }
            else
            {
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for GetMessageCampaign200Response and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        {
            return this.Equals(input as GetMessageCampaign200Response);
        }

        /// <summary>
        /// Returns true if GetMessageCampaign200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetMessageCampaign200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMessageCampaign200Response input)
        {
            if (input == null)
                return false;
