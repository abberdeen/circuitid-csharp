...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDeveloperApp200Response :  IEquatable<GetDeveloperApp200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeveloperApp200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDeveloperApp200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDeveloperApp200Response" /> class.
        /// </summary>
        ...
        public GetDeveloperApp200Response(string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), VisibilityEnum visibility = default(VisibilityEnum), RequireIdEnum? requireId = RequireIdEnum.NUMBER_0, IsFreeEnum? isFree = IsFreeEnum.NUMBER_1, string feeDescription = default(string), IntegrationTypeEnum integrationType = default(IntegrationTypeEnum), List<ServicesEnum> services = default(List<ServicesEnum>), List<EventsEnum> events = default(List<EventsEnum>), string user = default(string), string webhookUrl = default(string), string termsOfServiceUrl = default(string), string privacyPolicyUrl = default(string), Object permissions = default(Object), StatusEnum status = StatusEnum.Pending, WebhookAuthTypeEnum? webhookAuthType = default(WebhookAuthTypeEnum?), string webhookUsername = default(string), string webhookPassword = default(string), string webhookTokenName = default(string), string webhookToken = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (visibility == null)
            {
                throw new InvalidDataException("visibility is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("integrationType is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
            ...
            if (services == null)
            {
                throw new InvalidDataException("services is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
                this.User = user;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GetDeveloperApp200Response and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public List<GetDeveloperApp200Response.ServicesEnum> Services { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name="events", EmitDefaultValue=false)]
        public List<GetDeveloperApp200Response.EventsEnum> Events { get; set; }
        ...
        {
            return this.Equals(input as GetDeveloperApp200Response);
        }

        /// <summary>
        /// Returns true if GetDeveloperApp200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDeveloperApp200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDeveloperApp200Response input)
        {
            if (input == null)
                return false;
