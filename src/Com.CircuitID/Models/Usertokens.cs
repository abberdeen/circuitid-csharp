...
namespace Com.CircuitID.Models
{
    ...
    public partial class Usertokens :  IEquatable<Usertokens>, IValidatableObject
    {
        ...
        public Usertokens(string name = default(string), string user = default(string), string token = default(string), int expiresInYears = 1, StatusEnum? status = StatusEnum.NUMBER_1)
        {
