...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimeschedulesCreateOrPatch :  IEquatable<TimeschedulesCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Timezone
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeschedulesCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeschedulesCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeschedulesCreateOrPatch" /> class.
        /// </summary>
        ...
        public TimeschedulesCreateOrPatch(string name = default(string), TimezoneEnum timezone = TimezoneEnum.AmericaNewYork, Dictionary<string, List<Object>> sunday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> monday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> tuesday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> wednesday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> thursday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> friday = default(Dictionary<string, List<Object>>), Dictionary<string, List<Object>> saturday = default(Dictionary<string, List<Object>>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (timezone == null)
            {
                throw new InvalidDataException("timezone is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (sunday == null)
            {
                throw new InvalidDataException("sunday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Sunday = sunday;
            ...
            if (monday == null)
            {
                throw new InvalidDataException("monday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Monday = monday;
            ...
            if (tuesday == null)
            {
                throw new InvalidDataException("tuesday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (wednesday == null)
            {
                throw new InvalidDataException("wednesday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (thursday == null)
            {
                throw new InvalidDataException("thursday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (friday == null)
            {
                throw new InvalidDataException("friday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Friday = friday;
            ...
            if (saturday == null)
            {
                throw new InvalidDataException("saturday is a required property for TimeschedulesCreateOrPatch and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TimeschedulesCreateOrPatch);
        }

        /// <summary>
        /// Returns true if TimeschedulesCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeschedulesCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeschedulesCreateOrPatch input)
        {
            if (input == null)
                return false;
