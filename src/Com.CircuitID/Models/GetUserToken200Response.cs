...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserToken200Response :  IEquatable<GetUserToken200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserToken200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUserToken200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserToken200Response" /> class.
        /// </summary>
        ...
        public GetUserToken200Response(string name = default(string), string user = default(string), string token = default(string), int expiresInYears = 1, StatusEnum? status = StatusEnum.NUMBER_1, string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetUserToken200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for GetUserToken200Response and cannot be null");
            }
            else
            {
                this.User = user;
            ...
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for GetUserToken200Response and cannot be null");
            }
            else
            {
                this.Token = token;
            ...
            {
                throw new InvalidDataException("expiresInYears is a required property for GetUserToken200Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetUserToken200Response);
        }

        /// <summary>
        /// Returns true if GetUserToken200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserToken200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserToken200Response input)
        {
            if (input == null)
                return false;
