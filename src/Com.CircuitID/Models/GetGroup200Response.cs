...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetGroup200Response :  IEquatable<GetGroup200Response>, IValidatableObject
    {
        ...
        public GetGroup200Response(string name = default(string), string description = default(string), StatusEnum? status = StatusEnum.NUMBER_1, string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
