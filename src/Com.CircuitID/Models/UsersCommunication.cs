...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersCommunication :  IEquatable<UsersCommunication>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersCommunication" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UsersCommunication);
        }

        /// <summary>
        /// Returns true if UsersCommunication instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersCommunication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersCommunication input)
        {
            if (input == null)
                return false;
