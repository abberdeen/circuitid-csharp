...
namespace Com.CircuitID.Models
{
    ...
    public partial class Phoneinboundruleactions :  IEquatable<Phoneinboundruleactions>, IValidatableObject
    {
        ...
        public Phoneinboundruleactions(string name = default(string), string phoneinboundrule = default(string), string timeschedule = default(string), int timeout = default(int), StatusEnum? status = StatusEnum.NUMBER_1, int priority = 1, DestinationTypeEnum destinationType = default(DestinationTypeEnum), string destination = default(string), string _ref = default(string), string callForwardingDestination = default(string))
        {
