...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetHoliday200Response :  IEquatable<GetHoliday200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHoliday200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetHoliday200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHoliday200Response" /> class.
        /// </summary>
        ...
        public GetHoliday200Response(string name = default(string), string _object = default(string), string objectRef = default(string), List<List<DateTime>> dateTimeRanges = default(List<List<DateTime>>), StatusEnum? status = StatusEnum.NUMBER_1, DestinationTypeEnum destinationType = default(DestinationTypeEnum), string destination = default(string), string _ref = default(string), string callForwardingDestination = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetHoliday200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for GetHoliday200Response and cannot be null");
            }
            else
            {
                this.Object = _object;
            ...
            if (objectRef == null)
            {
                throw new InvalidDataException("objectRef is a required property for GetHoliday200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("dateTimeRanges is a required property for GetHoliday200Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("destinationType is a required property for GetHoliday200Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetHoliday200Response);
        }

        /// <summary>
        /// Returns true if GetHoliday200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetHoliday200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHoliday200Response input)
        {
            if (input == null)
                return false;
