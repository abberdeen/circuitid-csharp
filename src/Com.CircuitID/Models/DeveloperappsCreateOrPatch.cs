...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeveloperappsCreateOrPatch :  IEquatable<DeveloperappsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeveloperappsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeveloperappsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeveloperappsCreateOrPatch" /> class.
        /// </summary>
        ...
        public DeveloperappsCreateOrPatch(string name = default(string), string description = default(string), TypeEnum type = default(TypeEnum), VisibilityEnum visibility = default(VisibilityEnum), RequireIdEnum? requireId = RequireIdEnum.NUMBER_0, IsFreeEnum? isFree = IsFreeEnum.NUMBER_1, string feeDescription = default(string), IntegrationTypeEnum integrationType = default(IntegrationTypeEnum), List<ServicesEnum> services = default(List<ServicesEnum>), List<EventsEnum> events = default(List<EventsEnum>), string user = default(string), string webhookUrl = default(string), string termsOfServiceUrl = default(string), string privacyPolicyUrl = default(string), Object permissions = default(Object), WebhookAuthTypeEnum? webhookAuthType = default(WebhookAuthTypeEnum?), string webhookUsername = default(string), string webhookPassword = default(string), string webhookTokenName = default(string), string webhookToken = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DeveloperappsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (visibility == null)
            {
                throw new InvalidDataException("visibility is a required property for DeveloperappsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("integrationType is a required property for DeveloperappsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (services == null)
            {
                throw new InvalidDataException("services is a required property for DeveloperappsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for DeveloperappsCreateOrPatch and cannot be null");
            }
            else
            {
                this.User = user;
        ...
        public List<DeveloperappsCreateOrPatch.ServicesEnum> Services { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name="events", EmitDefaultValue=false)]
        public List<DeveloperappsCreateOrPatch.EventsEnum> Events { get; set; }
        ...
        {
            return this.Equals(input as DeveloperappsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if DeveloperappsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of DeveloperappsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeveloperappsCreateOrPatch input)
        {
            if (input == null)
                return false;
