...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientsCreateOrPatch :  IEquatable<ClientsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Manufacture
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientsCreateOrPatch" /> class.
        /// </summary>
        ...
        public ClientsCreateOrPatch(string name = default(string), string user = default(string), string mac = default(string), string httpUserAgent = default(string), ManufactureEnum? manufacture = default(ManufactureEnum?), StatusEnum? status = StatusEnum.NUMBER_1)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ClientsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for ClientsCreateOrPatch and cannot be null");
            }
            else
            {
                this.User = user;
            ...
            if (mac == null)
            {
                throw new InvalidDataException("mac is a required property for ClientsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Mac = mac;
        ...
        {
            return this.Equals(input as ClientsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if ClientsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientsCreateOrPatch input)
        {
            if (input == null)
                return false;
