...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class OfficesCreateOrPatch :  IEquatable<OfficesCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficesCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OfficesCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficesCreateOrPatch" /> class.
        /// </summary>
        ...
        public OfficesCreateOrPatch(string name = default(string), string streetNumber = default(string), string streetName = default(string), string preDirection = default(string), string streetSuffix = default(string), string zipCode = default(string), string address2 = default(string), string country = default(string), string region = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OfficesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("streetNumber is a required property for OfficesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (streetName == null)
            {
                throw new InvalidDataException("streetName is a required property for OfficesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("streetSuffix is a required property for OfficesCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for OfficesCreateOrPatch and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OfficesCreateOrPatch);
        }

        /// <summary>
        /// Returns true if OfficesCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of OfficesCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfficesCreateOrPatch input)
        {
            if (input == null)
                return false;
