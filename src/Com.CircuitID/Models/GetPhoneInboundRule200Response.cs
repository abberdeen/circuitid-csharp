...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPhoneInboundRule200Response :  IEquatable<GetPhoneInboundRule200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneInboundRule200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPhoneInboundRule200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneInboundRule200Response" /> class.
        /// </summary>
        ...
        public GetPhoneInboundRule200Response(string name = default(string), string description = default(string), string outboundCallerId = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetPhoneInboundRule200Response and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GetPhoneInboundRule200Response);
        }

        /// <summary>
        /// Returns true if GetPhoneInboundRule200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPhoneInboundRule200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPhoneInboundRule200Response input)
        {
            if (input == null)
                return false;
