...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetPhoneInboundRule200Response :  IEquatable<GetPhoneInboundRule200Response>, IValidatableObject
    {
        ...
        public GetPhoneInboundRule200Response(string name = default(string), string description = default(string), string outboundCallerId = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
