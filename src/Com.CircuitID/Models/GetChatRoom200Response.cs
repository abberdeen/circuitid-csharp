...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetChatRoom200Response :  IEquatable<GetChatRoom200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetChatRoom200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetChatRoom200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetChatRoom200Response" /> class.
        /// </summary>
        ...
        public GetChatRoom200Response(string name = default(string), Object users = default(Object), string avatar = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "users" is required (not null)
            if (users == null)
            {
                throw new InvalidDataException("users is a required property for GetChatRoom200Response and cannot be null");
            }
            else
            {
                this.Users = users;
        ...
        {
            return this.Equals(input as GetChatRoom200Response);
        }

        /// <summary>
        /// Returns true if GetChatRoom200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetChatRoom200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetChatRoom200Response input)
        {
            if (input == null)
                return false;
