...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetChatRoom200Response :  IEquatable<GetChatRoom200Response>, IValidatableObject
    {
        ...
        public GetChatRoom200Response(string name = default(string), Object users = default(Object), string avatar = default(string), bool direct = default(bool), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
