...
namespace Com.CircuitID.Models
{
    ...
    public partial class Firewall :  IEquatable<Firewall>, IValidatableObject
    {
        ...
        public Firewall(string name = default(string), string description = default(string), int priority = default(int), TypeEnum type = default(TypeEnum), TargetEnum target = default(TargetEnum), DirectionEnum? direction = default(DirectionEnum?), string param = default(string), int hits = default(int), AiEnum? ai = AiEnum.NUMBER_0, StatusEnum? status = StatusEnum.NUMBER_1, int notificationHits = 1)
        {
