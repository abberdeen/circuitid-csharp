...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetRateCenter200Response :  IEquatable<GetRateCenter200Response>, IValidatableObject
    {
        ...
        public GetRateCenter200Response(string npa = default(string), string nxx = default(string), string lata = default(string), string locState = default(string), string rcAbbre = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
