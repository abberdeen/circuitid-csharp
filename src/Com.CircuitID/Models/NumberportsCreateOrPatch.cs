...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class NumberportsCreateOrPatch :  IEquatable<NumberportsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberportsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumberportsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberportsCreateOrPatch" /> class.
        /// </summary>
        ...
        public NumberportsCreateOrPatch(List<string> numbers = default(List<string>), string name = default(string), TypeOfServiceEnum typeOfService = default(TypeOfServiceEnum), string authorizedPerson = default(string), DateTime desiredDueDate = default(DateTime), string accountNumber = default(string), string accountPhoneNumber = default(string), string office = default(string), E911Enum? e911 = E911Enum.NUMBER_0, DestinationTypeEnum destinationType = default(DestinationTypeEnum), string destination = default(string), string callForwardingDestination = default(string))
        {
            // to ensure "numbers" is required (not null)
            if (numbers == null)
            {
                throw new InvalidDataException("numbers is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("typeOfService is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("authorizedPerson is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("desiredDueDate is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountNumber is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("accountPhoneNumber is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (office == null)
            {
                throw new InvalidDataException("office is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Office = office;
            ...
            {
                throw new InvalidDataException("destinationType is a required property for NumberportsCreateOrPatch and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NumberportsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if NumberportsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberportsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberportsCreateOrPatch input)
        {
            if (input == null)
                return false;
