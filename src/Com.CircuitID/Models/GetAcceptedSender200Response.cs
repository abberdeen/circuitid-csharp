...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetAcceptedSender200Response :  IEquatable<GetAcceptedSender200Response>, IValidatableObject
    {
        ...
        public GetAcceptedSender200Response(string _object = default(string), string service = default(string), string serviceRef = default(string), RefEnum _ref = default(RefEnum), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
