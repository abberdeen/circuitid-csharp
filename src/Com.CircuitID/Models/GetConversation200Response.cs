...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetConversation200Response :  IEquatable<GetConversation200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Channel
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConversation200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConversation200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConversation200Response" /> class.
        /// </summary>
        ...
        public GetConversation200Response(List<Object> contacts = default(List<Object>), string number = default(string), ChannelEnum channel = default(ChannelEnum), RefEnum _ref = default(RefEnum), string _object = default(string), StatusEnum status = StatusEnum.Open, string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "channel" is required (not null)
            if (channel == null)
            {
                throw new InvalidDataException("channel is a required property for GetConversation200Response and cannot be null");
            }
            else
            {
            ...
            if (_ref == null)
            {
                throw new InvalidDataException("_ref is a required property for GetConversation200Response and cannot be null");
            }
            else
            {
                this.Ref = _ref;
            ...
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for GetConversation200Response and cannot be null");
            }
            else
            {
                this.Object = _object;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GetConversation200Response and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        {
            return this.Equals(input as GetConversation200Response);
        }

        /// <summary>
        /// Returns true if GetConversation200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConversation200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConversation200Response input)
        {
            if (input == null)
                return false;
