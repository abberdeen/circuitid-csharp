...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConferenceroomsCreateOrPatch :  IEquatable<ConferenceroomsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Lobby
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConferenceroomsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConferenceroomsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConferenceroomsCreateOrPatch" /> class.
        /// </summary>
        ...
        public ConferenceroomsCreateOrPatch(string name = default(string), string passcode = default(string), int dialInPin = default(int), bool isUserRoom = default(bool), bool isChatRoom = default(bool), LobbyEnum? lobby = LobbyEnum.NUMBER_0, RequirePasscodeEnum? requirePasscode = RequirePasscodeEnum.NUMBER_0, ShareEnum? share = default(ShareEnum?), string chatroom = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ConferenceroomsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as ConferenceroomsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if ConferenceroomsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of ConferenceroomsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConferenceroomsCreateOrPatch input)
        {
            if (input == null)
                return false;
