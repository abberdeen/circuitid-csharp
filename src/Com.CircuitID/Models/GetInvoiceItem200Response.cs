...
namespace Com.CircuitID.Models
{
    ...
    public partial class GetInvoiceItem200Response :  IEquatable<GetInvoiceItem200Response>, IValidatableObject
    {
        ...
        public GetInvoiceItem200Response(string name = default(string), int amount = default(int), int setup = default(int), int taxes = default(int), int quantity = 1, string invoice = default(string), string _ref = default(string), string _object = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
