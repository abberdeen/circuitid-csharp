...
namespace Com.CircuitID.Models
{
    ...
    public partial class Messagebrands :  IEquatable<Messagebrands>, IValidatableObject
    {
        ...
        public Messagebrands(string name = default(string), string brandId = default(string), string ein = default(string), string user = default(string), string order = default(string), StatusEnum? status = default(StatusEnum?), string brandRelationship = default(string), string vertical = default(string), string entityType = default(string), string cspId = default(string), string einIssuingCountry = default(string), string universalEin = default(string), string referenceId = default(string))
        {
