...
namespace Com.CircuitID.Models
{
    ...
    public partial class FindGroupMembers200Response :  IEquatable<FindGroupMembers200Response>, IValidatableObject
    {
        ...
        public FindGroupMembers200Response(int total = default(int), int limit = default(int), int skip = default(int), List<Groupmembers> data = default(List<Groupmembers>))
        {
        ...
        public List<Groupmembers> Data { get; set; }
