...
namespace Com.CircuitID.Models
{
    ...
    public partial class FindGroupMembers200Response :  IEquatable<FindGroupMembers200Response>, IValidatableObject
    {
        ...
        public FindGroupMembers200Response(int total = default(int), int limit = default(int), int skip = default(int), List<GetGroupMember200Response> data = default(List<GetGroupMember200Response>))
        {
        ...
        public List<GetGroupMember200Response> Data { get; set; }
