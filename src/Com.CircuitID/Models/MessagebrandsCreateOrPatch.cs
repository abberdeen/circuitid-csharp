...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessagebrandsCreateOrPatch :  IEquatable<MessagebrandsCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagebrandsCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessagebrandsCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagebrandsCreateOrPatch" /> class.
        /// </summary>
        ...
        public MessagebrandsCreateOrPatch(string name = default(string), string brandId = default(string), string ein = default(string), string user = default(string), string order = default(string), string brandRelationship = default(string), string vertical = default(string), string entityType = default(string), string cspId = default(string), string einIssuingCountry = default(string), string universalEin = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for MessagebrandsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (ein == null)
            {
                throw new InvalidDataException("ein is a required property for MessagebrandsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Ein = ein;
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for MessagebrandsCreateOrPatch and cannot be null");
            }
            else
            {
                this.User = user;
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for MessagebrandsCreateOrPatch and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        {
            return this.Equals(input as MessagebrandsCreateOrPatch);
        }

        /// <summary>
        /// Returns true if MessagebrandsCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of MessagebrandsCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessagebrandsCreateOrPatch input)
        {
            if (input == null)
                return false;
