...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPhoneOutboundRule200Response :  IEquatable<GetPhoneOutboundRule200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneOutboundRule200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPhoneOutboundRule200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPhoneOutboundRule200Response" /> class.
        /// </summary>
        ...
        public GetPhoneOutboundRule200Response(string name = default(string), string description = default(string), StatusEnum? status = StatusEnum.NUMBER_1, string outboundCallerId = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetPhoneOutboundRule200Response and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GetPhoneOutboundRule200Response);
        }

        /// <summary>
        /// Returns true if GetPhoneOutboundRule200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPhoneOutboundRule200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPhoneOutboundRule200Response input)
        {
            if (input == null)
                return false;
