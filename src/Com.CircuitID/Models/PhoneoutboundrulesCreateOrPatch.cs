...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneoutboundrulesCreateOrPatch :  IEquatable<PhoneoutboundrulesCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneoutboundrulesCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PhoneoutboundrulesCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneoutboundrulesCreateOrPatch" /> class.
        /// </summary>
        ...
        public PhoneoutboundrulesCreateOrPatch(string name = default(string), string description = default(string), StatusEnum? status = StatusEnum.NUMBER_1, string outboundCallerId = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PhoneoutboundrulesCreateOrPatch and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as PhoneoutboundrulesCreateOrPatch);
        }

        /// <summary>
        /// Returns true if PhoneoutboundrulesCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneoutboundrulesCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneoutboundrulesCreateOrPatch input)
        {
            if (input == null)
                return false;
