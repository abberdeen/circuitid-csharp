...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetConferenceRoom200Response :  IEquatable<GetConferenceRoom200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Lobby
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConferenceRoom200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConferenceRoom200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConferenceRoom200Response" /> class.
        /// </summary>
        ...
        public GetConferenceRoom200Response(string name = default(string), string passcode = default(string), int dialInPin = default(int), bool isUserRoom = default(bool), bool isChatRoom = default(bool), LobbyEnum? lobby = LobbyEnum.NUMBER_0, RequirePasscodeEnum? requirePasscode = RequirePasscodeEnum.NUMBER_0, ShareEnum? share = default(ShareEnum?), string chatroom = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetConferenceRoom200Response and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GetConferenceRoom200Response);
        }

        /// <summary>
        /// Returns true if GetConferenceRoom200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConferenceRoom200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConferenceRoom200Response input)
        {
            if (input == null)
                return false;
