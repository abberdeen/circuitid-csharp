...
namespace Com.CircuitID.Models
{
    ...
    public partial class Phoneoutboundrules :  IEquatable<Phoneoutboundrules>, IValidatableObject
    {
        ...
        public Phoneoutboundrules(string name = default(string), string description = default(string), StatusEnum? status = StatusEnum.NUMBER_1, string outboundCallerId = default(string))
        {
