...
namespace Com.CircuitID.Models
{
    ...
    public partial class Invoiceitems :  IEquatable<Invoiceitems>, IValidatableObject
    {
        ...
        public Invoiceitems(string name = default(string), int amount = default(int), int setup = default(int), int taxes = default(int), int quantity = 1, string invoice = default(string), string _ref = default(string), string _object = default(string))
        {
