...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCustomer200Response :  IEquatable<GetCustomer200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="callDebug", EmitDefaultValue=false)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomer200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCustomer200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomer200Response" /> class.
        /// </summary>
        ...
        /// <param name="callForwardingCallLimit">callForwardingCallLimit (default to 10).</param>
        ...
        /// <param name="lowBalanceAlertCount">lowBalanceAlertCount (default to 0).</param>
        ...
        /// <param name="callDebug">callDebug (default to CallDebugEnum.NUMBER_0).</param>
        ...
        public GetCustomer200Response(string name = default(string), StatusEnum? status = StatusEnum.Active, string websiteUrl = default(string), string logo = default(string), int credit = 0, string adminUserId = default(string), string billingUserId = default(string), string callRecordingUserId = default(string), int callForwardingCallLimit = 10, string supportUserId = default(string), int automaticRefillAmount = 0, int lowBalanceAlertAmount = 0, DateTime lowBalanceAlertAt = default(DateTime), int lowBalanceAlertCount = 0, string lastAutomaticRefillInvoice = default(string), InternationalCallingEnum? internationalCalling = InternationalCallingEnum.NUMBER_0, string createdByIP = default(string), CallDebugEnum? callDebug = CallDebugEnum.NUMBER_0, MediaBypassEnum? mediaBypass = MediaBypassEnum.NUMBER_0, AccountLockEnum? accountLock = AccountLockEnum.NUMBER_1, CallRecordingEnum? callRecording = CallRecordingEnum.NUMBER_0, int cdrRetention = 12, CnamLookUpsEnum? cnamLookUps = CnamLookUpsEnum.NUMBER_0, HoldMusicEnum? holdMusic = HoldMusicEnum.NUMBER_0, TranscribeCallsEnum? transcribeCalls = default(TranscribeCallsEnum?), int maxOutboundCallRate = 1, DefaultBillMethodEnum defaultBillMethod = DefaultBillMethodEnum.Credit, string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetCustomer200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("defaultBillMethod is a required property for GetCustomer200Response and cannot be null");
            }
            else
            {
            ...
            // use default value if no "callForwardingCallLimit" provided
            if (callForwardingCallLimit == null)
            {
                this.CallForwardingCallLimit = 10;
            }
            else
            {
            ...
            // use default value if no "lowBalanceAlertCount" provided
            if (lowBalanceAlertCount == null)
            {
                this.LowBalanceAlertCount = 0;
            }
            else
            {
            ...
            // use default value if no "callDebug" provided
            if (callDebug == null)
            {
                this.CallDebug = CallDebugEnum.NUMBER_0;
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="callForwardingCallLimit", EmitDefaultValue=false)]
        public int CallForwardingCallLimit { get; set; }
        ...
        /// </summary>
        [DataMember(Name="lowBalanceAlertAt", EmitDefaultValue=false)]
        public DateTime LowBalanceAlertAt { get; set; }

        /// <summary>
        /// Gets or Sets LowBalanceAlertCount
        /// </summary>
        [DataMember(Name="lowBalanceAlertCount", EmitDefaultValue=false)]
        public int LowBalanceAlertCount { get; set; }

        /// <summary>
        /// ObjectId (unique 12 bytes ID)
        /// </summary>
        /// <value>ObjectId (unique 12 bytes ID)</value>
        [DataMember(Name="lastAutomaticRefillInvoice", EmitDefaultValue=false)]
        public string LastAutomaticRefillInvoice { get; set; }
        ...
        {
            return this.Equals(input as GetCustomer200Response);
        }

        /// <summary>
        /// Returns true if GetCustomer200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCustomer200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCustomer200Response input)
        {
            if (input == null)
                return false;
