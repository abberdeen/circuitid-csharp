...
namespace Com.CircuitID.Models
{
    ...
    public partial class FindChatRooms200Response :  IEquatable<FindChatRooms200Response>, IValidatableObject
    {
        ...
        public FindChatRooms200Response(int total = default(int), int limit = default(int), int skip = default(int), List<GetChatRoom200Response> data = default(List<GetChatRoom200Response>))
        {
        ...
        public List<GetChatRoom200Response> Data { get; set; }
