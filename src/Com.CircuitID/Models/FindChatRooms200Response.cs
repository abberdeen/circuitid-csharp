...
namespace Com.CircuitID.Models
{
    ...
    public partial class FindChatRooms200Response :  IEquatable<FindChatRooms200Response>, IValidatableObject
    {
        ...
        public FindChatRooms200Response(int total = default(int), int limit = default(int), int skip = default(int), List<Chatrooms> data = default(List<Chatrooms>))
        {
        ...
        public List<Chatrooms> Data { get; set; }
