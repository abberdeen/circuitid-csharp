...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RatecentersCreateOrPatch :  IEquatable<RatecentersCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatecentersCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RatecentersCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RatecentersCreateOrPatch" /> class.
        /// </summary>
        ...
        public RatecentersCreateOrPatch(string npa = default(string), string nxx = default(string), string lata = default(string), string locState = default(string), string rcAbbre = default(string))
        {
            // to ensure "npa" is required (not null)
            if (npa == null)
            {
                throw new InvalidDataException("npa is a required property for RatecentersCreateOrPatch and cannot be null");
            }
            else
            {
                this.Npa = npa;
            ...
            if (nxx == null)
            {
                throw new InvalidDataException("nxx is a required property for RatecentersCreateOrPatch and cannot be null");
            }
            else
            {
                this.Nxx = nxx;
            ...
            if (lata == null)
            {
                throw new InvalidDataException("lata is a required property for RatecentersCreateOrPatch and cannot be null");
            }
            else
            {
                this.Lata = lata;
            ...
            if (locState == null)
            {
                throw new InvalidDataException("locState is a required property for RatecentersCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (rcAbbre == null)
            {
                throw new InvalidDataException("rcAbbre is a required property for RatecentersCreateOrPatch and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RatecentersCreateOrPatch);
        }

        /// <summary>
        /// Returns true if RatecentersCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of RatecentersCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatecentersCreateOrPatch input)
        {
            if (input == null)
                return false;
