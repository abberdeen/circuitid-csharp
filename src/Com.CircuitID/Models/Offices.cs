...
namespace Com.CircuitID.Models
{
    ...
    public partial class Offices :  IEquatable<Offices>, IValidatableObject
    {
        ...
        public Offices(string name = default(string), string streetNumber = default(string), string streetName = default(string), string preDirection = default(string), string streetSuffix = default(string), string city = default(string), string state = default(string), string zip = default(string), string zipCode = default(string), string address2 = default(string), string country = default(string), Object providers = default(Object), string region = default(string))
        {
