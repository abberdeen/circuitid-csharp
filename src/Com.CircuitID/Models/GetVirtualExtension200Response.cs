...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetVirtualExtension200Response :  IEquatable<GetVirtualExtension200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetVirtualExtension200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetVirtualExtension200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetVirtualExtension200Response" /> class.
        /// </summary>
        ...
        public GetVirtualExtension200Response(string name = default(string), int extension = default(int), string phoneinboundrule = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetVirtualExtension200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (extension == null)
            {
                throw new InvalidDataException("extension is a required property for GetVirtualExtension200Response and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="phoneinboundrule", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as GetVirtualExtension200Response);
        }

        /// <summary>
        /// Returns true if GetVirtualExtension200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetVirtualExtension200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetVirtualExtension200Response input)
        {
            if (input == null)
                return false;
