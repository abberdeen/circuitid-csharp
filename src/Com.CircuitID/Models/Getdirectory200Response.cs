...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Getdirectory200Response :  IEquatable<Getdirectory200Response>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Getdirectory200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Getdirectory200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Getdirectory200Response" /> class.
        /// </summary>
        ...
        public Getdirectory200Response(string name = default(string), TypeEnum type = default(TypeEnum), List<string> groups = default(List<string>), string announcement = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Getdirectory200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Getdirectory200Response and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as Getdirectory200Response);
        }

        /// <summary>
        /// Returns true if Getdirectory200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Getdirectory200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Getdirectory200Response input)
        {
            if (input == null)
                return false;
