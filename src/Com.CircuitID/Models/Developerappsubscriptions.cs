...
namespace Com.CircuitID.Models
{
    ...
    public partial class Developerappsubscriptions :  IEquatable<Developerappsubscriptions>, IValidatableObject
    {
        ...
        public Developerappsubscriptions(string developerApp = default(string), string _object = default(string), string _ref = default(string), Object permissions = default(Object), RequireIdEnum? requireId = RequireIdEnum.NUMBER_0, List<ServicesEnum> services = default(List<ServicesEnum>), List<EventsEnum> events = default(List<EventsEnum>))
        {
        ...
        public List<Developerappsubscriptions.ServicesEnum> Services { get; set; }

        /// <summary>
        /// Gets or Sets Events
        /// </summary>
        [DataMember(Name="events", EmitDefaultValue=false)]
        public List<Developerappsubscriptions.EventsEnum> Events { get; set; }
