...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersCreateOrPatch :  IEquatable<UsersCreateOrPatch>, IValidatableObject
    {
        /// <summary>
        /// Defines Language
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersCreateOrPatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsersCreateOrPatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersCreateOrPatch" /> class.
        /// </summary>
        ...
        public UsersCreateOrPatch(string email = default(string), string password = default(string), string first = default(string), string last = default(string), string mobilePhone = default(string), string businessPhone = default(string), int extension = default(int), int customCallerId = default(int), string jobTitle = default(string), string department = default(string), string office = default(string), string avatar = default(string), LanguageEnum? language = LanguageEnum.En, IsPrimaryEnum? isPrimary = IsPrimaryEnum.NUMBER_0, VmGreetingTypeEnum? vmGreetingType = VmGreetingTypeEnum.Default, int vmTimeout = 20, string vmFile = default(string), string vmPlaybackNumber = default(string), int pin = 1234, string number = default(string), string region = default(string), string callerIdNumber = default(string), AdminPermissionEnum? adminPermission = default(AdminPermissionEnum?), BillingPermissionEnum? billingPermission = default(BillingPermissionEnum?), PhonePermissionEnum? phonePermission = default(PhonePermissionEnum?), TimezoneEnum timezone = TimezoneEnum.AmericaNewYork, VmTranscriptionEnum? vmTranscription = VmTranscriptionEnum.NUMBER_0, Dictionary<string, UsersCommunicationValue> communication = default(Dictionary<string, UsersCommunicationValue>))
        {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for UsersCreateOrPatch and cannot be null");
            }
            else
            {
            ...
            if (first == null)
            {
                throw new InvalidDataException("first is a required property for UsersCreateOrPatch and cannot be null");
            }
            else
            {
                this.First = first;
            ...
            if (last == null)
            {
                throw new InvalidDataException("last is a required property for UsersCreateOrPatch and cannot be null");
            }
            else
            {
                this.Last = last;
            ...
            if (timezone == null)
            {
                throw new InvalidDataException("timezone is a required property for UsersCreateOrPatch and cannot be null");
            }
            else
            {
        ...
        public Dictionary<string, UsersCommunicationValue> Communication { get; set; }
        ...
        {
            return this.Equals(input as UsersCreateOrPatch);
        }

        /// <summary>
        /// Returns true if UsersCreateOrPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersCreateOrPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersCreateOrPatch input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Communication.SequenceEqual(input.Communication)
                );
        }
