...
namespace Com.CircuitID.Models
{
    ...
    public partial class Announcements :  IEquatable<Announcements>, IValidatableObject
    {
        ...
        public Announcements(List<string> attachments = default(List<string>), string name = default(string), TypeEnum type = default(TypeEnum), string voice = default(string), string text = default(string))
        {
