...
namespace Com.CircuitID.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetMenuOption200Response :  IEquatable<GetMenuOption200Response>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMenuOption200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMenuOption200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMenuOption200Response" /> class.
        /// </summary>
        ...
        public GetMenuOption200Response(string name = default(string), int digit = default(int), Object menus = default(Object), DestinationTypeEnum destinationType = default(DestinationTypeEnum), string destination = default(string), string _ref = default(string), string callForwardingDestination = default(string), string id = default(string), string createdByUserId = default(string), string updatedByUserId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetMenuOption200Response and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (digit == null)
            {
                throw new InvalidDataException("digit is a required property for GetMenuOption200Response and cannot be null");
            }
            else
            {
                this.Digit = digit;
            ...
            if (menus == null)
            {
                throw new InvalidDataException("menus is a required property for GetMenuOption200Response and cannot be null");
            }
            else
            {
                this.Menus = menus;
            ...
            {
                throw new InvalidDataException("destinationType is a required property for GetMenuOption200Response and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetMenuOption200Response);
        }

        /// <summary>
        /// Returns true if GetMenuOption200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetMenuOption200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMenuOption200Response input)
        {
            if (input == null)
                return false;
