...
namespace Com.CircuitID.Models
{
    ...
    public partial class FindVirtualExtensions200Response :  IEquatable<FindVirtualExtensions200Response>, IValidatableObject
    {
        ...
        public FindVirtualExtensions200Response(int total = default(int), int limit = default(int), int skip = default(int), List<Virtualextensions> data = default(List<Virtualextensions>))
        {
        ...
        public List<Virtualextensions> Data { get; set; }
