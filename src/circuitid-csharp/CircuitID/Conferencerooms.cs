...
namespace circuitid-csharp.CircuitID
{
    ...
    public partial class Conferencerooms :  IEquatable<Conferencerooms>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="isUserRoom", EmitDefaultValue=true)]
        public IsUserRoomEnum? IsUserRoom { get; set; }
        /// <summary>
        /// Defines IsChatRoom
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        [DataMember(Name="isChatRoom", EmitDefaultValue=true)]
        public IsChatRoomEnum? IsChatRoom { get; set; }
        /// <summary>
        /// Defines Lobby
        /// </summary>
        ...
        /// Gets or Sets Lobby
        /// </summary>
        [DataMember(Name="lobby", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="requirePasscode", EmitDefaultValue=true)]
        ...
        /// <param name="requirePasscode">requirePasscode.</param>
        /// <param name="share">share.</param>
        /// <param name="chatroom">ObjectId (unique 12 bytes ID).</param>
        public Conferencerooms(Object name = default(Object), Object passcode = default(Object), Object dialInPin = default(Object), IsUserRoomEnum? isUserRoom = default(IsUserRoomEnum?), IsChatRoomEnum? isChatRoom = default(IsChatRoomEnum?), LobbyEnum? lobby = default(LobbyEnum?), RequirePasscodeEnum? requirePasscode = default(RequirePasscodeEnum?), ShareEnum? share = default(ShareEnum?), Object chatroom = default(Object))
        {
        ...
        /// </summary>
        [DataMember(Name="dialInPin", EmitDefaultValue=true)]
        public Object DialInPin { get; set; }
        ...
        [DataMember(Name="chatroom", EmitDefaultValue=true)]
        public Object Chatroom { get; set; }
