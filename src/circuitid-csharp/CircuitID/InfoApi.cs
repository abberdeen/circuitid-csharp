...
namespace circuitid-csharp.CircuitID
{
    ...
    public interface IInfoApi : IApiAccessor
    {
        ...
        ApiResponse<Object> FindInfoWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<Object> FindInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> FindInfoWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class InfoApi : IInfoApi
    {
        ...
        /// <returns></returns>
        public InfoApi(circuitid-csharp.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = FindInfoWithHttpInfo();
        ...
        /// <exception cref="circuitid-csharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse<Object> FindInfoWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("FindInfo", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> FindInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Object> localVarResponse = await FindInfoWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> FindInfoWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
